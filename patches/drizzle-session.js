/**
 * NOTE:
 * DrizzleのバグによってBunのテストでgetメソッドおよびfindFirstメソッドが機能しないため、  node_modules/drizzle-orm/bun-sqlite/session.jsのgetメソッドを上書き修正している https://github.com/drizzle-team/drizzle-orm/pull/1276/files
...
class PreparedQuery extends PreparedQueryBase {
  ...
  all(placeholderValues) {
    const { fields, query, logger, joinsNotNullableMap, stmt, customResultMapper } =
      this
